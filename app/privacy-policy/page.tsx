export default function PrivacyPolicy() {
  return (
    <div className="space-y-12 text-md md:text-lg text-muted-foreground pb-4 md:pb-8">
      ...
      <p>
        At ConvertMe, we are committed to safeguarding your privacy. This
      ...
      <div className="space-y-2">
        ...
        <p>
          ...
          data we collect, please contact us at kishore.k.kumar@outlook.com.
        </p>
      </div>

      <p>
        By using ConvertMe, you agree to the practices outlined in this Privacy
